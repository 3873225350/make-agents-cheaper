...
\begin{enumerate}[leftmargin=2em]
    \item \textbf{Provider stability.} The active provider should point to the intended cache-aware route, supplied outside the source tree when exact endpoint verification is required.
